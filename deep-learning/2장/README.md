...
| 파일명        | 파일 용도                         | 관련 절                        | 페이지 |
|---------------|-----------------------------------|--------------------------------|--------|
| `and_gate.py` | 단층 퍼셉트론으로 AND 게이트 구현 | 2.3.3 가중치와 편향 구현하기   | 53     |
| `nand_gate.py`| 단층 퍼셉트론으로 NAND 게이트 구현| 2.3.3 가중치와 편향 구현하기   | 53     |
| `or_gate.py`  | 단층 퍼셉트론으로 OR 게이트 구현  | 2.3.3 가중치와 편향 구현하기   | 53     |
| `xor_gate.py` | 2층 퍼셉트론으로 XOR 게이트 구현  | 2.5.2 XOR 게이트 구현하기      | 59     |
...
(한계)임계값
# 📌 AND 게이트
![2](https://github.com/user-attachments/assets/16fe58e0-c455-4d96-ab18-0af688dcb015)
...
# 📌 XOR 게이트
![1](https://github.com/user-attachments/assets/d1d89d49-9702-4f03-9ae3-ba8fd8bcf2ed)
...
![3](https://github.com/user-attachments/assets/1e14b34c-080f-4f2d-b2c2-3dce566bf4fe)
